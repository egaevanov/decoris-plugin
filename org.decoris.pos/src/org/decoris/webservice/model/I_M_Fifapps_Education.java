...
/** Generated Interface for M_Fifapps_Education
 *  @author iDempiere (generated) 
 *  @version Release 3.1
 */
@SuppressWarnings("all")
public interface I_M_Fifapps_Education 
{

    /** TableName=M_Fifapps_Education */
    public static final String Table_Name = "M_Fifapps_Education";
    ...
    public static final String COLUMNNAME_bistatus = "bistatus";
    ...
    /** Column name bistatusref */
    public static final String COLUMNNAME_bistatusref = "bistatusref";
    ...
    /** Column name edudescr */
    public static final String COLUMNNAME_edudescr = "edudescr";
    ...
    /** Column name edutype */
    public static final String COLUMNNAME_edutype = "edutype";
    ...
    /** Column name lippobankcode */
    public static final String COLUMNNAME_lippobankcode = "lippobankcode";
    ...
    /** Column name M_Fifapps_Education_UU */
    public static final String COLUMNNAME_M_Fifapps_Education_UU = "M_Fifapps_Education_UU";
