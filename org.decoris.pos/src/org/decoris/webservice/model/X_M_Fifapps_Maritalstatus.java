...
/** Generated Model for M_Fifapps_Maritalstatus
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_M_Fifapps_Maritalstatus extends PO implements I_M_Fifapps_Maritalstatus, I_Persistent 
{
    ...
    public X_M_Fifapps_Maritalstatus (Properties ctx, int M_Fifapps_Maritalstatus_ID, String trxName)
    {
      super (ctx, M_Fifapps_Maritalstatus_ID, trxName);
      /** if (M_Fifapps_Maritalstatus_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_M_Fifapps_Maritalstatus (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_Fifapps_Maritalstatus[")
	...
	public void setM_Fifapps_Maritalstatus_ID (int M_Fifapps_Maritalstatus_ID)
	{
		if (M_Fifapps_Maritalstatus_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_Fifapps_Maritalstatus_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_M_Fifapps_Maritalstatus_ID, Integer.valueOf(M_Fifapps_Maritalstatus_ID));
	}
	...
	/** Set M_Fifapps_Maritalstatus_UU.
		@param M_Fifapps_Maritalstatus_UU M_Fifapps_Maritalstatus_UU	  */
	public void setM_Fifapps_Maritalstatus_UU (String M_Fifapps_Maritalstatus_UU)
	{
		set_ValueNoCheck (COLUMNNAME_M_Fifapps_Maritalstatus_UU, M_Fifapps_Maritalstatus_UU);
	}

	/** Get M_Fifapps_Maritalstatus_UU.
		@return M_Fifapps_Maritalstatus_UU	  */
	public String getM_Fifapps_Maritalstatus_UU () 
	{
		return (String)get_Value(COLUMNNAME_M_Fifapps_Maritalstatus_UU);
	}

	/** Set maritaldesc.
		@param maritaldesc maritaldesc	  */
	public void setmaritaldesc (String maritaldesc)
	{
		set_Value (COLUMNNAME_maritaldesc, maritaldesc);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_maritaldesc);
	}

	/** Set maritalstat.
		@param maritalstat maritalstat	  */
	public void setmaritalstat (String maritalstat)
	{
		set_Value (COLUMNNAME_maritalstat, maritalstat);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_maritalstat);
	}
