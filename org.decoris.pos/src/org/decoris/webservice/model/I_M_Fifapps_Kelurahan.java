...
/** Generated Interface for M_Fifapps_Kelurahan
 *  @author iDempiere (generated) 
 *  @version Release 3.1
 */
@SuppressWarnings("all")
public interface I_M_Fifapps_Kelurahan 
{

    /** TableName=M_Fifapps_Kelurahan */
    public static final String Table_Name = "M_Fifapps_Kelurahan";
    ...
    /** Column name kelcode */
    public static final String COLUMNNAME_kelcode = "kelcode";
    ...
    public static final String COLUMNNAME_kelurahan = "kelurahan";
    ...
    /** Column name M_Fifapps_Kelurahan_ID */
    public static final String COLUMNNAME_M_Fifapps_Kelurahan_ID = "M_Fifapps_Kelurahan_ID";
    ...
    /** Column name M_Fifapps_Kelurahan_UU */
    public static final String COLUMNNAME_M_Fifapps_Kelurahan_UU = "M_Fifapps_Kelurahan_UU";
