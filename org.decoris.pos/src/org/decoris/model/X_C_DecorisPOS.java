...
/** Generated Model for C_DecorisPOS
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_C_DecorisPOS extends PO implements I_C_DecorisPOS, I_Persistent 
{
    ...
    public X_C_DecorisPOS (Properties ctx, int C_DecorisPOS_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_C_DecorisPOS (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_DecorisPOS[")
	...
	/** Set C_DecorisPOS_UU.
		@param C_DecorisPOS_UU C_DecorisPOS_UU	  */
	public void setC_DecorisPOS_UU (String C_DecorisPOS_UU)
	{
		set_ValueNoCheck (COLUMNNAME_C_DecorisPOS_UU, C_DecorisPOS_UU);
	}

	/** Get C_DecorisPOS_UU.
		@return C_DecorisPOS_UU	  */
	public String getC_DecorisPOS_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_DecorisPOS_UU);
	}
