...
public class DecorisPrintPreOrder extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		if(isPassStatus){
			...
			msg = "Dokumen PO belum Dapat Di Proses";
		}
	...
	protected int updateData(int C_Decoris_PreOrder_ID){
		...
		SQLExFunction.append("SELECT update_print_info_po_fifapps(?)");
