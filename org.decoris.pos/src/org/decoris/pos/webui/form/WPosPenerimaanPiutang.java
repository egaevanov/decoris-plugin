 ...
 * @author Tegar N
 *
 * Decoris Pembayaran Pelanggan
 *
 */

public class WPosPenerimaanPiutang extends PosPenerimaanPiutang implements IFormController,
...
//		tutupKasFlag.setEnabled(false);
	...
	public void valueChange(ValueChangeEvent evt) {
		try {
			...
			if (name.equals(MDecorisPOS.COLUMNNAME_C_DecorisPOS_ID)){
...
//						C_BankAcct_ID = b_acct_id;
				...
				decPos.setDateOrdered(pay.getDateTrx());
