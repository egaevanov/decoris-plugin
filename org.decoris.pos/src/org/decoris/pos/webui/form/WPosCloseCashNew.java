...
public class WPosCloseCashNew extends PosCloseCashNew implements IFormController,
...
//		}
	...
	public void process(){
		...
		sqlTutupKas.append(" FROM decoris_closecash_summary_v ");
		...
		sqlUpdateTutupKas.append("SELECT C_DecorisPOS_ID ");
		sqlUpdateTutupKas.append(" FROM C_DecorisPOS ");
