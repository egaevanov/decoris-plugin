...
public class WPosPembatalan extends PosPembatalan implements IFormController,EventListener<Event>, WTableModelListener, ValueChangeListener{
		...
		private MDecorisPOS decNew = null;
		boolean isManualDocumentNo = false;
		String msgInfo = "";

		public WPosPembatalan() {
		...
		public void onEvent(Event e) throws Exception {
			...
			if (e.getTarget().equals(noNotaTB)){
				...
				if(noNotaTB.getValue().toString()!= null && noNotaTB.getValue().toString()!= "" ){
					...
					data = getTrxData(detailList, resultTable);
		...
		protected void configureMiniTable(IMiniTable miniTable) {
				...
				miniTable.setColumnClass(2, int.class, true); 	
