 ...
 * @author Tegar N
 * 
 * Decoris Refund Pembelian
 */

public class WPosRMA extends PosRMA implements IFormController,
	...
	public void onEvent(Event e) throws Exception {
		...
		if(e.getTarget().equals(processReturn)){
			...
			try {
				...
				rma.setClientOrg(AD_Client_ID, inOut.getAD_Org_ID());
				...
				for(int i = 0; i < ReturnTable.getRowCount(); i++){
					...
					if(IsSelected){
						...
						line.setClientOrg(AD_Client_ID, rma.getAD_Org_ID());
				...
				APCreditMemo.setClientOrg(inOut.getAD_Client_ID(), inOut.getAD_Org_ID());
